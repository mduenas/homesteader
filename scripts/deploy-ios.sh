...
ARCHIVE_PATH="${TMPDIR:-/tmp}/homesteader-${STAMP}.xcarchive"
EXPORT_PATH="${TMPDIR:-/tmp}/homesteader-${STAMP}-export"
EXPORT_OPTIONS="${TMPDIR:-/tmp}/homesteader-${STAMP}-ExportOptions.plist"
