...
PACKAGE_NAME="${ANDROID_PACKAGE_NAME:-com.markduenas.homesteader}"
...
Options:
  ...
  --release-status <completed|draft|inProgress|halted>  Play release status
  -h, --help                                  Show help
